...
// pin@p17 { function = "output"; termination = "pull_up"; polarity = "active_high"; startup_state = "active"; };
// pin@p26 { function = "output"; termination = "no_pulling"; polarity = "active_low"; startup_state = "inactive"; drive_strength_mA = < 8 >; };
